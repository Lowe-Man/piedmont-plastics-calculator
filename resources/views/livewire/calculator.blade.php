<form wire:submit.prevent="submit" class="calculator-container">
    ...
    <div class="material mx-4">
        ...
        <select id="material" wire:model="material" class="border cursor-pointer border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 rounded-sm">
    ...
    <div class="length ml-4 mr-1 mt-4">
        ...
        <input type="text" id="length" wire:model="length" class="border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full text-center rounded-sm">
    </div>
    <div class="width mr-4 ml-1 mt-4">
        ...
        <input type="text" id="width" wire:model="width" class="border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full text-center rounded-sm">
    </div>
    ...
    <div class="calculate-btn flex flex-col justify-end ml-1 mr-4 mb-4">
        @if($errors->has('width') || $errors->has('length'))
            <button type="submit" class="text-white bg-[#00A0DE] hover:bg-[#0080b1] disabled:bg-[#99C7E3] disabled:cursor-not-allowed focus:ring-4 focus:ring-blue-300 font-medium text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 w-full h-[42px] rounded-sm" disabled="disabled">Calculate</button>
        @else
            <button type="submit" class="text-white bg-[#00A0DE] hover:bg-[#0080b1] disabled:bg-[#99C7E3] disabled:cursor-not-allowed focus:ring-4 focus:ring-blue-300 font-medium text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 w-full h-[42px] rounded-sm">Calculate</button>
        @endif
    </div>
</form>
